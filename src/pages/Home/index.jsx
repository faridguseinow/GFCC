    ...
    <div className="home-page">
      ...
      {showNotice && (
        <div className="launch-notice glass">
          <div className="notice-content">
            ...
            <li>
              Обновлена главная страница: улучшена структура каталога и отображение ассортимента.
            </li>
            <li>
              Обновлена база клиентов Golden Flowers и добавлена база клиентов Oasis Flowers. База клиентов теперь синхронизируется с обеими системами, обеспечивая полный и актуальный список клиентов.
            </li>
            <li>
              Улучшена стабильность, безопасность и оптимизирована работа приложения.
            </li>
      ...
      {!hasClientBarcode && (
        <div className="qr-about-wrapper">
          ...
          <p>
            - Введите 6-значный код, полученный в офисе (на кассе). Используйте штрихкод для быстрого доступа к вашему профилю во время подсчета товаров.
          </p>
          <p>
